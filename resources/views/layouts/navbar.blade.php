...
<aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-white shadow-xl flex flex-col h-full z-30 -translate-x-full md:translate-x-0 transition-transform duration-300">
    ...
    <nav class="flex-grow p-4 space-y-2 overflow-y-auto">
        ...
        <div class="relative x-dropdown">
            ...
            <div class="{{ request()->routeIs('invoice.*') || request()->routeIs('kwitansi.*') || request()->routeIs('surat-jalan.*') || request()->routeIs('surat-penawaran.*') || request()->routeIs('purchase-order.*') ? 'block' : 'hidden' }} pl-11 pr-4 py-2 space-y-1 mt-1 font-medium text-sm">
