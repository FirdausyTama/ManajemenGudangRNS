        ...
        <div class="max-w-7xl mx-auto relative z-10">
          <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p class="text-gray-500 text-sm mt-1">Kelola dan pantau seluruh kwitansi transaksi Anda</p>
            </div>
          </div>
            ...
            <form id="addForm" action="{{ route('kwitansi.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="date" name="tanggal_kwitansi" value="{{ date('Y-m-d') }}" max="{{ date('Y-m-d') }}" required class="w-full rounded-lg border-gray-300 border px-4 py-2 text-sm focus:ring-rns-blue focus:border-rns-blue bg-white">
                    </div>
                </div>
                ...
                <div class="bg-white p-5 rounded-lg border border-gray-200 shadow-sm mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2 p-3 bg-blue-50 border border-blue-100 rounded-lg">
                            ...
                            <p class="text-[11px] text-gray-500 mt-1">Hanya bisa mencetak Kwitansi otomatis untuk penjualan yang sudah Cicilan atau Lunas.</p>
                        </div>
                    </div>
                </div>
