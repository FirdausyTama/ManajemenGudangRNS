        ...
        <div class="max-w-7xl mx-auto relative z-10">
          <div class="py-3 flex flex-col sm:flex-row justify-between items-center mb-6">
            <div>
              ...
              <p class="text-gray-500 text-sm">Kelola dan pantau seluruh surat jalan pengiriman Anda</p>
            </div>
            
            <div class="mt-4 sm:mt-0 flex gap-2">
              <form action="{{ route('surat-jalan.index') }}" method="GET" class="flex items-center">
                 ...
                 <input type="text" name="search" value="{{ request('search') }}" 
                        placeholder="Cari SJ/Penerima..." class="border border-gray-300 px-3 py-2 text-sm outline-none focus:ring-rns-blue" />
